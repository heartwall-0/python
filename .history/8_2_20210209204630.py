...
LastEditTime: 2021-02-09 20:46:30
...
该函数将默认输入dog。
定义这种含默认值的函数，默认值一定在非默认值得后面，
describe_pets(pet_name, animal_type = 'dog'): 对
describe_pets(animal_type = 'dog', pet_name): 报错SyntaxError: non-default argument follows default argument
'''
